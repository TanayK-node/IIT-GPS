...
# ============================================================
# INTERACTIVE ROUTE DRAWING TOOL (IITB CAMPUS)
# ============================================================

import folium
from folium.plugins import Draw

print("\nCreating interactive drawing map...")

# ------------------------------------------------------------
# Convert roads to WGS84 (for web map)
# ------------------------------------------------------------
roads_wgs = roads.to_crs(epsg=4326)

# ------------------------------------------------------------
# Compute map center from road network
# ------------------------------------------------------------
center = [
    roads_wgs.geometry.centroid.y.mean(),
    roads_wgs.geometry.centroid.x.mean()
]
...
# ------------------------------------------------------------
# Optional: Show road network lightly
# ------------------------------------------------------------
folium.GeoJson(
    roads_wgs,
...
draw = Draw(
    ...
    position='topleft',
    draw_options={
        'polyline': True,     # Enable route drawing
        'polygon': False,
        'circle': False,
        'rectangle': False,
        'marker': False,
...
# Save Map
# ------------------------------------------------------------
m_draw.save("draw_routes.html")

print("Map saved as: draw_routes.html")
print("Open this file in your browser.")
print("Draw 3 routes using the polyline tool.")
print("Click 'Export' and save the GeoJSON file.")
