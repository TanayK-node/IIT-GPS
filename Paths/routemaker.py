...
POINTS_FILE = "./Mapmatchedpoints/yellow_reference_route_points.csv" # Ensure this path is correct!
...
OUTPUT_HTML = "yellow_assigned_route_WITH_EXTRA_PATHS.html"
m.save(OUTPUT_HTML)
...
# 9. SAVE TO GPKG
# =========================
GPKG_FILE = "yellow_assigned_route.gpkg"
